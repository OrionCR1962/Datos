...
namespace BlazorPeliculas.Client.Repositorios
{
    public class Repositorio : IRepositorio
    {
        ...
        public async Task<HttpResponseWrapper<object>> Post<T>(string url, T enviar)
        {
            ...
            var responseHttp = await httpClient.PostAsync(url, enviarContext);
        ...
        public List<Pelicula> ObtenerPeliculas()
        {
            ...
            {
                new Pelicula {Titulo = "WAKANDA FOR EVER",Lanzamiento = new DateTime(2022,11,11),
                Poster="https://upload.wikimedia.org/wikipedia/en/3/3b/Black_Panther_Wakanda_Forever_poster.jpg"},
                new Pelicula {Titulo = "Moana",Lanzamiento = new DateTime(2026,11,23),
